...
from .views import index,signup,signin,account_dashboard,logout,privacy_setting,dashboard_manu,home_page,calendar,horizontal_menu,horizontal_top_menu,two_sidebar,vertical_top_menu,transfer
...
urlpatterns = [
    ...
    path('setting', privacy_setting, name='privacy_setting'),
    path('setting/dashboard_manu', dashboard_manu, name='dashboard_manu'),
    path('dashboard/dashboard_manu', dashboard_manu, name='dashboard_manu'),
